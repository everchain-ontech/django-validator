...
class ValidatorTest(TestCase):
    ...
    @ddt.data(
        ...
        (MaxValidator(10), True, SimpleUploadedFile('test', b'test')),
        (MaxValidator(10), False, SimpleUploadedFile('test', b't' * 11)),
        # Min
        ...
        (MinValidator(10), True, SimpleUploadedFile('test', b't' * 10)),
        (MinValidator(10), False, SimpleUploadedFile('test', b'test')),
        # Between
        ...
        (BetweenValidator(5, 10), True, SimpleUploadedFile('test', b't' * 10)),
        (BetweenValidator(5, 10), False, SimpleUploadedFile('test', b'test')),
        (BetweenValidator(5, 10), False, SimpleUploadedFile('test', b't' * 20)),
        # Regex
